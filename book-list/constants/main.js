const bookList = {
	"1": {
		...
		"2": {
			...
			"price": 31.99,
			"image": "https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/7899/9781789957648.jpg",
			"title": "Clean Code in JavaScript",
			"shortDescription": "Building robust apps starts with creating clean code. In this book, you'll explore techniques for doing this by learning everything from the basics of JavaScript through to the practices of clean code.",
...
for (var key in bookList) {
	out += '<div class="books_list">';
	out += '<img src="'+bookList[key].image+'">'+ '<br>';
	out += '<h3>'+'Author: '+'<span>'+bookList[key].author+'</span>'+'</h3>'+ '<br>';
	out += '<p>Price: '+'<span>'+bookList[key].price+'$'+'</span>'+'</p>' + '<br>';
	out += '<h3>'+'Title: '+'<span>'+bookList[key].title+'</span>'+'</h3>' + '<br>';
	out += '<h3>'+'Description: '+'<span>'+bookList[key].shortDescription+'</span>'+'</h3>' + '<br>';
	out += '<button class="add-to-cart"data-price="10000" data-show="0" href="#"' + key + '">Buy</button>';
	out += '</div>';
};
